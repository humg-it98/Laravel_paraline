        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <div class="login-wrap p-4 p-md-5">
                    ...
                    <h3 class="text-center mb-4">Login Paraline</h3>
                    <form action="{{route('admin.check')}}" class="login-form" method="POST">
                        @csrf
